return {
  descriptions = {
    Joker = {
      ...
      j_RainyDays_burdenofgreatness = {
        ...
        text = {
          "On {C:attention}purchase{} or when {C:attention}Boss Blind{} is",
          "defeated, earn {C:money}$25{} and increase",
          "all required scores by {C:attention}#2#%"
        }
      },
      ...
      j_RainyDays_heirloom = {
        name = "Heirloom",
        text = {
          "When played {C:attention}Bonus{} or",
      ...
      j_RainyDays_kudzu = {
        name = "Kudzu",
        text = {
          "Whenever {C:attention}#1#{}",
          "or higher ranking {C:attention}poker",
          "{C:attention}hand{} is upgraded, it",
          "gains {C:mult}+#2#{} additional Mult"
        }
      },
      ...
      j_RainyDays_lady_of_the_lake = {
        ...
        text = {
          ...
          "{C:attention}enhanced{} cards, random scoring",
          "card gains random {C:attention}enhancement"
        }
      },
      ...
      j_RainyDays_lotteryticket = {
        name = "Lottery Ticket",
        text = {
          "First played {C:attention}#1#{}, {C:attention}#2#{},",
          "{C:attention}#3#{}, {C:attention}#4#{}, or {C:attention}#5#{} earns {C:money}$#6#{}",
          "when first scored, then",
          "increase payout by {C:money}$#7#{}",
          "{s:0.8}Resets payout and changes",
          "{s:0.8}listed ranks each round"
        }
      },
      ...
      j_RainyDays_truffle = {
        name = "Truffle",
        text = {
          "Next {C:attention}#1#{} face cards",
          "played become {C:dark_edition}Foil",
          "when scored"
        }
      },
      ...
      j_RainyDays_waste_not = {
        name = "Waste Not",
        text = {
          "Each discard, each discarded",
          "{C:attention}card{} permanently transfers",
          "{C:chips}#1#{} Chips to random card {C:attention}held",
          "in hand"
        }
      }
    },
  ...
  misc = {
    dictionary = {
      ...
      rainydays_plus_constellation = "+1 Constellation"
    },
    
    labels = {
      rainydays_ivory_seal = "Ivory Seal",
      rainydays_mint_seal = "Mint Seal"
    }
  }
}