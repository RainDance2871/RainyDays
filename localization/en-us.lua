    ...
    Joker = {
      j_RainyDays_bankaccount = {
        ...
        text = {
          "{C:chips}+#1#{} Chips",
          "Add any earned",
          "{C:attention}interest{} to this Joker's",
      ...
      j_RainyDays_burdenofgreatness = {
        ...
        text = {
          "Earn {C:money}$#1#{} and increase all",
          "required scores by {C:attention}#2#%{} on",
          "{C:attention}purchase{} and when {C:attention}Boss Blind",
          "is defeated",
        }
      },
      ...
      j_RainyDays_kintsugi = {
        ...
        text = {
          ...
          "is destroyed, shuffle a",
          "copy with a {C:attention}Gold Seal",
          "into your deck"
        }
      },
